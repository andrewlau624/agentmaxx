...
2. Run the project's analyzer or test suite via the terminal tool (e.g. `npm test`, `pytest`, `flutter analyze`).
3. If it fails, fix the code internally without asking the user.
4. Only when checks pass are you allowed to end your turn and output the JSON status block above.
